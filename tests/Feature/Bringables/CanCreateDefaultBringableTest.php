...
class CanCreateDefaultBringableTest extends TestCase
{
    use RefreshDatabase;
    /**
     ...
     * @return void
     */
    public function test_can_create_a_bringable()
    {
    ...
    public function test_can_create_and_assign_a_bringable()
    {
    ...
    public function test_can_create_and_assign_some_bringables_multiple()
    {
    ...
    public function test_can_create_and_assign_some_bringables_infinity()
    {
